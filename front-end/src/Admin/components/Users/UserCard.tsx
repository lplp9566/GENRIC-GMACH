    ...
    <StyledCard onClick={() => toggleExpand()}>
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <CardContent sx={{ bgcolor: "grey.50" }}>
          ...
          <List disablePadding sx={{ mb: 2 }}>
            {loans.map((ln) => {
              ...
              return (
                ...
                >
                  <ListItemAvatar>
                    <Avatar sx={{ bgcolor: neg ? "error.main" : "success.main" }}>
          ...
          <Typography variant="body2"><strong>טלפון:</strong> {user.phone_number}</Typography>
          <Typography variant="body2"><strong>ת"ז:</strong> {user.id_number}</Typography>
